		...
		loader.load(data.src, function (geometry, materials) {
			...
			materials.forEach(function (mat) {
				...
				if ( mat.normalMap )
				{
					...
					// mat.ambientOcclusionMap= {type: 'map'},
					// mat.ambientOcclusionMapIntensity= {default: 1},
					// mat.ambientOcclusionTextureOffset= {type: 'vec2'},
					// mat.ambientOcclusionTextureRepeat= {type: 'vec2', default: {x: 1, y: 1}},
					// mat.color= {type: 'color'},
					// mat.displacementMap= {type: 'map'},
					// mat.displacementScale= {default: 1},
					// mat.displacementBias= {default: 0.5},
					// mat.displacementTextureOffset= {type: 'vec2'},
					// mat.displacementTextureRepeat= {type: 'vec2', default: {x: 1, y: 1}},
					// mat.emissive= {type: 'color', default: '#000'},
					// mat.emissiveIntensity= {default: 1},
					// mat.envMap= {default: ''},
					// mat.fog= {default: true},
					// mat.height= {default: 256},
					// mat.metalness= {default: 0.0, min: 0.0, max: 1.0},
					// mat.normalMap= {type: 'map'},
					// mat.normalScale= {type: 'vec2', default: {x: 1, y: 1}},
					// mat.normalTextureOffset= {type: 'vec2'},
					// mat.normalTextureRepeat= {type: 'vec2', default: {x: 1, y: 1}},
					// mat.offset = {type: 'vec2', default: {x: 0, y: 0}},
					// mat.repeat = {type: 'vec2', default: {x: 1, y: 1}},
					// mat.roughness= {default: 0.5, min: 0.0, max: 1.0},
					// mat.sphericalEnvMap= {type: 'map'},
					// mat.src= {type: 'map'},
					// mat.width= {default: 512},
					// mat.wireframe= {default: false},
					// mat.wireframeLinewidth= {default: 2}
				}
			});
			
			//var ThreeMaterial = materials.length > 1 ? new THREE.MultiMaterial(materials) : materials[0];
			var ThreeMaterial = materials.length > 1 ? new THREE.MultiMaterial(materials) : materials[0];
			console.log(ThreeMaterial)
			var model = (geometry.bones || []).length
				? new THREE.SkinnedMesh(geometry, ThreeMaterial )
				: new THREE.Mesh(geometry, ThreeMaterial);
